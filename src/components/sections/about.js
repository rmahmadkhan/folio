...
const About = () => {
  ...
  const skills = ['Flutter', 'Firebase', 'iOS', 'Android'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Ahmad. While I have a comprehensive technical background,
              my emphasis is on mobile app development. I have been working as a software engineer since 2020
              and have developed a wide range of mobile apps for iOS and Android.
            </p>

            <p>
              Fast-forward to today, and I’ve had the privilege of working with multiple startups.
              To build products which have high user experience and performance has always been my top priority.
            </p>
